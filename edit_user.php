...
<body>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="mb-3">
                        <label class="form-label" for="inpt">User Name</label>
                        <input class="form-control" style="border: 1px solid #e0dddd" id="userinpt">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="mb-3">
                        <label class="form-label" for="inpt">Mobile Number</label>
                        <input class="form-control" type="number" style="border: 1px solid #e0dddd" id="mobileinpt">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="mb-3">
                        ...
                        <input class="form-control" type="password" style="border: 1px solid #e0dddd" id="passwordinpt">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="mb-3">
                        <label class="form-label" for="inpt">Branch</label>
                        <select class="form-select" style="border: 1px solid #e0dddd" id="branchinpt">
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="mb-3">
                        <label class="form-label" for="inpt">Role</label>
                        <select class="form-select" style="border: 1px solid #e0dddd" id="roleinpt">
                            <option value="" selected disabled> - Choose -</option>
                  ...
                  <div class="text-end">
                    ...
                    <button class="btn btn-primary" id="sourceadd" type="submit">Save Changes</button>
                  </div>
                </div>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button class="btn btn-danger" type="button" onclick="deletesource()">Delete</button>
            </div>
          </div>
        </div>
      </div>
  ...
  <script>
    ...
    function postsource() {
      var nameinput = $('#nameinpt').val();
      var passwordinput = $('#passwordinpt').val();
      var mobileinput = $('#mobileinpt').val();
      var branchinput = $('#branchinpt').val();
      var roleinput = $('#roleinpt').val();
