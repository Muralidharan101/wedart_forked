...
<!-- Mirrored from admin.pixelstrap.com/koho/template/box-shadow.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 28 Jul 2023 10:02:34 GMT -->
<head>
              ...
              <div class="col-sm-12">
                <div class="card box-shadow-title">
                  <div class="card-header pb-0">
                    <h3>Examples</h3><span>While shadows on components are disabled by default in Bootstrap and can be enabled via <code>$enable-shadows</code>, you can also quickly add or remove a shadow with our <code>box-shadow</code> utility classes. Includes support for <code>.shadow-none</code> and three default sizes (which have associated variables to match).</span>
                  </div>
                  <div class="card-body">
                    <div class="row">
                      <div class="col-12">
