                  ...
                  <div class="row">
                    <div class="col">
                      <div class="mb-3">
                        ...
                        <input class="form-control" style="border: 1px solid #e0dddd" id="inpt1">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="mb-3">
                        ...
                        <input class="form-control" type="text" oninput="onlynum(this);" style="border: 1px solid #e0dddd" id="inpt2">
                      </div>
                    </div>
                  </div>
