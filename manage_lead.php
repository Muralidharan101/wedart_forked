              ...
              <div class="col-sm-12">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="mb-3">
                        <label class="form-label">Selected Additional Services</label>
                        <div 
                          id="listservice" 
                          class="form-control" disabled
                          style="border: 2px solid #e0dddd; background-color: transparent;min-height: 150px;"
                          placeholder="Selected Additional Service Will Display Here!">
                          <p style="color:#afadad">Additional Service Will Display Here!</p>
                        </div>
                      </div>
                    </div>
                  </div>
