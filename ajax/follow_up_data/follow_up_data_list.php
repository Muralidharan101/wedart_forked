<?php
    ...
    if ($lead == 'baby') 
    {
        $sql = "SELECT l.lead_no, l.name, l.event_dateTime, l.service, l.main_service, l.other_info, f.follow_up_date, f.approach, f.response   
    ...
    {
        $sql = "SELECT l.lead_no, l.name, l.event_date, l.service, l.main_service, l.other_info, f.follow_up_date, f.follow_up_details, f.approach, f.response  
